...
beatHitFuncs = { 
	...
	[395] = function()
    doTweenX('enter', 'dad', -500, 1.5, 'quadInOut')
    doTweenY('enterY', 'dad', 300, 1.5, 'quadInOut')
	end,
	[613] = function()
	...
	[833] = function()
    doTweenX('obamaout', 'dad', -600, 3.5, 'quadInOut')
	end,
	[842] = function()
...
function onStepHit()
    if curStep == 124 then
        doTweenAlpha('BL', 'BL', 1, 0.3, 'linear'); 
    end

    if curStep == 132 then
        doTweenAlpha('BL', 'BL', 0, 0.8, 'linear'); 
    end
end